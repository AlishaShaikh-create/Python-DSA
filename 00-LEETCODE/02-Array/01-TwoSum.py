...
#         num_map = {}
#         for i, num in enumerate(nums):  -> enumerate is used to store the values in the terms of key and value pair
...
# For an array of size n, this means we'd be doing roughly n×n operations, leading to a time complexity of O(n 
# 2
#  ). Given the problem constraints (up to 10 
# 4
#   elements), an O(n 
# 2
#  ) algorithm would be far too slow and would likely time out.
